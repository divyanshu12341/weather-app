...
function App() {
    ...
    return (
        <div className="w-full h-110vh bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center px-4  lg:px-0">
            {error && (
            ...
            {/* Form Input */}
            <form onSubmit={handleSubmit} className={`${animate ? "animate-bounce" : ""} h-16 bg-black/30 w-full max-w-[450px] rounded-full backdrop-blur-[32px]  mt-20 mb-8`}>
